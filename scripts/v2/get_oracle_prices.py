...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  3 17:11:15 2023
...
class GetOraclePrices:
    ...
    def __init__(self, chain: str):
        ...
        self.chain = chain
        self.oracle_url = {"arbitrum": "https://arbitrum-api.gmxinfra.io/signed_prices/latest",
    ...
    def _process_output(self, output: dict):
        """
        Take the API response and create a new dictionary where the index token addresses are the
        keys
